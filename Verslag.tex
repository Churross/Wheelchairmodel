...
\caption{The cost of function of the time till the wheelchairs will unusable}
...
Figure 16.3 shows a graph which looks similar to a plotted trigonometric function, with the angle measured in degrees. However when the functions are consulted, non such function can be derived. But when looking at the range of the graph, there is a fluctuation of 0.01 eurocents. Zooming out on the graph results then also in a straight line\footnote{by approximation}.
